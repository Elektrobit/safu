...
CMAKE_PARAM="${CMAKE_PARAM} -D CMOCKA_EXTENSIONS_URI=${SOURCES_URI}/cmocka-extensions.git \
    -D CMOCKA_EXTENSIONS_REF=fs/rename-doc-target"
CMAKE_PARAM="${CMAKE_PARAM} -D CMOCKA_MOCKS_URI=${SOURCES_URI}/cmocka-mocks.git \
    -D CMOCKA_MOCKS_REF=fs/rename-doc-target"
