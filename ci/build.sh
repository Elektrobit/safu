...
CMOCKA_EXTENSIONS_REPO_PATH=${CMOCKA_EXTENSIONS_REPO:-${SOURCES_URI}/${CMOCKA_EXTENSIONS_REPO_NAME}}
CMOCKA_EXTENSIONS_REPO_REF=${CMOCKA_EXTENSIONS_REPO_REF:-integration}
CMOCKA_EXTENSIONS_REPO_REF="task/#18927-split-cmocka_extensions-into-its-own-repo"

CMOCKA_MOCKS_REPO_NAME=${CMOCKA_MOCKS_REPO_NAME:-cmocka-mocks.git}
CMOCKA_MOCKS_REPO_PATH=${CMOCKA_MOCKS_REPO:-${SOURCES_URI}/${CMOCKA_MOCKS_REPO_NAME}}
CMOCKA_MOCKS_REPO_REF=${CMOCKA_MOCKS_REPO_REF:-integration}
CMOCKA_MOCKS_REPO_REF="task/#18928-copy-cmocka_mocks-into-its-own-repo"
