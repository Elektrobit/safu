...
MOCK_FUNC_PROTOTYPE(safuVecCreate, int, safuVec_t *vec, uint32_t elements,
                    uint32_t elementSize)
MOCK_FUNC_PROTOTYPE(safuVecFree, int, safuVec_t *vec)
MOCK_FUNC_PROTOTYPE(safuVecInsert, int, safuVec_t *vec, uint32_t idx,
                    const void *element)
...
MOCK_FUNC_PROTOTYPE(safuVecSet, int, safuVec_t *vec, uint32_t idx,
                    const void *element)
...
MOCK_FUNC_PROTOTYPE(safuVecFind, int, const safuVec_t *vec, uint32_t startIdx,
                    safuVecFunc_t matchFunc, const void *matchData,
                    uint32_t *resultIdx)
MOCK_FUNC_PROTOTYPE(safuVecFindGet, int, const safuVec_t *vec, void **element,
                    uint32_t *idx, safuVecFunc_t matchFunc,
                    const void *matchData)
MOCK_FUNC_PROTOTYPE(safuVecFindRemove, int, safuVec_t *vec,
                    safuVecFunc_t matchFunc, const void *matchData)
