...
MOCK_FUNC_PROTOTYPE(safuLogFuncF, safuLogStatusE_t, safuLogLevelE_t level,
                    const char *file, const char *func, unsigned int line,
                    const char *fmt, ...)
MOCK_FUNC_PROTOTYPE(safuLogFunc, safuLogStatusE_t, safuLogLevelE_t level,
                    const char *file, const char *func, unsigned int line,
                    const char *fmt)
MOCK_FUNC_PROTOTYPE(safuLogSetPrefix, safuLogStatusE_t, const char *prefix)
MOCK_FUNC_PROTOTYPE(safuLogSetStream, safuLogStatusE_t, safuLogLevelE_t level,
                    FILE *stream)
MOCK_FUNC_PROTOTYPE(safuLogSetStreamLevel, safuLogStatusE_t,
                    safuLogLevelE_t level)
MOCK_FUNC_PROTOTYPE(safuLogSetCallbackFunc, safuLogStatusE_t,
