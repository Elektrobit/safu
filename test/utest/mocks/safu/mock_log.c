...
MOCK_FUNC_BODY(safuLogFuncF, safuLogStatusE_t, safuLogLevelE_t level,
...
MOCK_FUNC_BODY(safuLogFunc, safuLogStatusE_t, safuLogLevelE_t level,
               const char *file, const char *func, unsigned int line,
               const char *fmt) {
  safuLogStatusE_t result;
  va_list args;
...
MOCK_FUNC_BODY(safuLogSetStream, safuLogStatusE_t, safuLogLevelE_t level,
               FILE *stream) {
  safuLogStatusE_t result;
...
MOCK_FUNC_BODY(safuLogSetCallbackFunc, safuLogStatusE_t,
