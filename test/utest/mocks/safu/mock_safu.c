...
MOCK_FUNC_BODY(safuGetEnvOr, const char *, const char *key,
...
MOCK_FUNC_BODY(safuReadFileToString, ssize_t, const char *fileName,
...
MOCK_FUNC_BODY(safuJsonAddObject, int, struct json_object *jobj,
...
MOCK_FUNC_BODY(safuJsonAddNewInt, struct json_object *,
...
MOCK_FUNC_BODY(safuJsonAddNewInt64, struct json_object *,
...
MOCK_FUNC_BODY(safuJsonAddNewUint64, struct json_object *,
...
MOCK_FUNC_BODY(safuJsonAddNewString, struct json_object *,
...
MOCK_FUNC_BODY(safuJsonAddNewArray, struct json_object *,
...
MOCK_FUNC_BODY(safuJsonAddNewArrayOfInitialSize, struct json_object *,
  ...
  return MOCK_FUNC_REAL(safuJsonAddNewArrayOfInitialSize)(jobj, name,
                                                          initialSize);
}

MOCK_FUNC_BODY(safuJsonAddNewTimestamp, struct json_object *,
               struct json_object *jobj, const char *name,
...
MOCK_FUNC_BODY(safuJsonGetInt32, int, const struct json_object *jobj,
...
MOCK_FUNC_BODY(safuJsonGetInt64, int, const struct json_object *jobj,
...
MOCK_FUNC_BODY(safuJsonGetObject, struct json_object *,
               const struct json_object *jobj, const char *name, size_t idx) {
...
MOCK_FUNC_BODY(safuJsonGetArray, struct json_object *,
               const struct json_object *jobj, const char *name, size_t idx,
               size_t *len) {
...
MOCK_FUNC_BODY(safuJsonGetUint32, int, const struct json_object *jobj,
...
MOCK_FUNC_BODY(safuJsonGetUint64, int, const struct json_object *jobj,
...
MOCK_FUNC_BODY(safuJsonGetString, int, const struct json_object *jobj,
...
MOCK_FUNC_BODY(safuJsonGetTimestamp, int, const struct json_object *jobj,
