...
MOCK_FUNC_BODY(safuVecCreate, int, safuVec_t *vec, uint32_t elements,
...
MOCK_FUNC_BODY(safuVecInsert, int, safuVec_t *vec, uint32_t idx,
               const void *element) {
...
MOCK_FUNC_BODY(safuVecSet, int, safuVec_t *vec, uint32_t idx,
               const void *element) {
...
int MOCK_FUNC_WRAP(safuVecFind)(const safuVec_t *vec, uint32_t startIdx,
                                safuVecFunc_t matchFunc, const void *matchData,
                                uint32_t *resultIdx) {
  ...
  return MOCK_FUNC_REAL(safuVecFind)(vec, startIdx, matchFunc, matchData,
                                     resultIdx);
}

MOCK_FUNC_VAR_NEW(safuVecFindGet);
int MOCK_FUNC_WRAP(safuVecFindGet)(const safuVec_t *vec, void **element,
                                   uint32_t *idx, safuVecFunc_t matchFunc,
  ...
  return MOCK_FUNC_REAL(safuVecFindGet)(vec, element, idx, matchFunc,
                                        matchData);
}

MOCK_FUNC_VAR_NEW(safuVecFindRemove);
int MOCK_FUNC_WRAP(safuVecFindRemove)(safuVec_t *vec, safuVecFunc_t matchFunc,
                                      const void *matchData) {
