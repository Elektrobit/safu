...
MOCK_FUNC_BODY(safuRingBufferInitialize, safuResultE_t,
...
MOCK_FUNC_BODY(safuRingBufferDeleteMembers, safuResultE_t,
               safuRingBuffer_t *ringBuffer) {
  safuResultE_t result;
...
MOCK_FUNC_BODY(safuRingBufferDelete, safuResultE_t,
               safuRingBuffer_t **ringBuffer) {
  safuResultE_t result;
...
MOCK_FUNC_BODY(safuRingBufferWrite, safuResultE_t, safuRingBuffer_t *ringBuffer,
               void *element) {
  safuResultE_t result;
...
MOCK_FUNC_BODY(safuRingBufferRead, safuResultE_t, safuRingBuffer_t *ringBuffer,
               safuVec_t *elementVector, size_t *elementsWritten) {
  safuResultE_t result;
  ...
  if (MOCK_IS_ACTIVE(safuRingBufferRead)) {
    ...
    result = MOCK_FUNC_REAL(safuRingBufferRead)(ringBuffer, elementVector,
                                                elementsWritten);
  }
