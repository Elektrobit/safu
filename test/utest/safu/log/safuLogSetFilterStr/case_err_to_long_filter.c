...
void safuTestSafuLogSetFilterStringErrToLongFilter(UNUSED void **state) {
  ...
  const char *toLongFilterStr =
      "example.c;mock_extref_dependency.c;mock_extref_dependency.h;mock_"
      "selfref.h;mock_selfref.c;example.c;example.c;"
      "library.c;selfref.c;weak_mock_dependency.c;dependency.c;dependency.h;"
      "samconf.c;signature.c;crypto_utils.c;uri."
      "c;samconf.pem;config_backend.c;json_backend.c;run_benchmarks.sh;"
      "samconfBase64Decode_utest.h;smconf"
