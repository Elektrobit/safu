...
int safuTestSafuJsonAddNewTimestampErrAddArrayObjectTeardown(UNUSED void **state) {
    return 0;
}
...
static void _testCase(const char *key, struct timespec timestamp) {
    ...
    struct json_object *jtimestamp = safuJsonAddNewTimestamp(NULL, key, &timestamp);
