...
SETUP(safuTestSafuJsonAddNewTimestampErrInsertSecObject)
TEARDOWN(safuTestSafuJsonAddNewTimestampErrInsertSecObject)
...
void safuTestSafuJsonAddNewTimestampErrInsertSecObject(void **state) {
  TEST("safuJsonAddNewTimestamp");
  SHOULD("%s",
         "fail to insert the seconds into a json timestamp for a json object");
