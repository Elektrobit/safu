...
SETUP(safuTestSafuJsonAddNewTimestampErrInsertSecArray)
TEARDOWN(safuTestSafuJsonAddNewTimestampErrInsertSecArray)
...
void safuTestSafuJsonAddNewTimestampErrInsertSecArray(void **state) {
  TEST("safuJsonAddNewTimestamp");
  SHOULD("%s",
         "fail to insert the seconds into a json timestamp for a json array");
