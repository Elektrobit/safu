...
SETUP(safuTestSafuJsonGetTimestampErrGetNSecsFailedObject)
TEARDOWN(safuTestSafuJsonGetTimestampErrGetNSecsFailedObject)
...
void safuTestSafuJsonGetTimestampErrGetNSecsFailedObject(void **state) {
    TEST("safuJsonGetTimestamp");
    SHOULD("%s", "fail to get the nanoseconds of a Timestamp from a json object");
