...
SETUP(safuTestSafuJsonAddNewBoolErrAddObjectFailedObject)
TEARDOWN(safuTestSafuJsonAddNewBoolErrAddObjectFailedObject)
...
void safuTestSafuJsonAddNewBoolErrAddObjectFailedObject(void **state) {
    TEST("safuJsonAddNewBool");
    SHOULD("%s", "fail to add a new bool to a json object");
