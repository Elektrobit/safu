...
#define SAFU_FLAG_HAS_INITIALIZED_BIT(__flag)                                  \
  ((atomic_load(__flag) & SAFU_FLAG_INITIALIZED_BIT) != 0)
#define SAFU_FLAG_HAS_ERROR_BIT(__flag)                                        \
  ((atomic_load(__flag) & SAFU_FLAG_ERROR_BIT) != 0)
